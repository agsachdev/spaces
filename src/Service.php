...
use agsachdev\spaces\interfaces\Service as ServiceInterface;
...
class Service extends Component implements ServiceInterface
{
     ...
     *
     * @return \agsachdev\spaces\CommandFactory
     */
     ...
     *
     * @return \agsachdev\spaces\interfaces\HandlerResolver
     */
    ...
    protected function defaultComponentDefinitions()
    {
        return [
            ...
            'resolver' => ['class' => 'agsachdev\spaces\HandlerResolver'],
            'bus' => ['class' => 'agsachdev\spaces\Bus'],
            'builder' => ['class' => 'agsachdev\spaces\CommandBuilder'],
            'factory' => ['class' => 'agsachdev\spaces\CommandFactory'],
        ];
    }
